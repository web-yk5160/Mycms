...
class TagsController extends BackendController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect("/backend/tags")->with('message', 'タグが作成されました');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("/backend/tags")->with('message', 'タグが編集されました');
    ...
    public function destroy($id)
    {
        ...
        return redirect("/backend/tags")->with('message', 'タグが削除されました');
